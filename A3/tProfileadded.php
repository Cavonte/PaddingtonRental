                  ...
                  <div class="col-md-4" >
                     ...
                     <p class="lead">
                        <?php            
                           ...
                           $query ="SELECT log_in FROM tprofiles WHERE log_in='$username' "; 
                           ...
                           if(mysqli_num_rows($response) <= 0){ 
                                 ...
                                 $query = "INSERT INTO  tprofiles(`pets`,`smoking`,`age`, `employed`,`income`,`log_in`)
                                 VALUES ('$pet','$smoking','$age','$job','$income','$username');";
                           
                                 if (mysqli_query($dbc, $query)) {
                                     echo '<br/>' . "Profile set." . '<br/>'   ;
                                 } else {
